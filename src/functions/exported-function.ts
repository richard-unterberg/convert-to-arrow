...
export const convertExportedFunction = (node: FunctionDeclaration, sourceFile: SourceFile): boolean => {
  ...
  node.replaceWithText(`${jsDocLead}export const ${parts.name} = ${arrowHead}`)
